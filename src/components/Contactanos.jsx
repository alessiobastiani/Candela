        ...
        <div className="pb-80 pt-16 sm:pb-40 sm:pt-24 lg:pb-48 lg:pt-40">
          <div className="relative mx-auto max-w-7xl px-4 sm:static sm:px-6 lg:px-8">
            <div className="sm:max-w-lg">
              ...
              Escríbenos por WhatsApp y te responderemos lo antes posible! Tu comodidad es nuestra prioridad, y estamos aquí para atender tus preguntas y necesidades de manera rápida y eficiente.
              </p>
            </div>
            <div>
              <div className="mt-10">
